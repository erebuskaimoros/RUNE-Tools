...
|---|---|---|---|
| 2026-03-22 #1 | Rapid Swaps full stack deploy + WebSocket listener | Deployed backend, redesigned UI (terminal aesthetic), tightened filters, built real-time WS listener on Hetzner, switched to thorchain.network endpoints. 30 swaps tracked, $230k volume. | `sessions/2026-03-22/session-1.md` |
...
- WebSocket listener running on Hetzner — monitor stability over next few days
